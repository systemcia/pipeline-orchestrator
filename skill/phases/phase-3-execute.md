...
> | 步骤 | 门控 | 执行方 | 跳过条件 |
> |------|------|--------|---------|
> | d-0 产出校验 | HARD | 主Agent内联 | PRE_SHA=NO_GIT |
> | d-0.5 验收标准 | HARD/SOFT | 主Agent内联 | 无`验收标准:`关键词 |
> | O9 依赖安装 | SOFT | 主Agent内联 | 无元数据文件 |
> | d-1 编译检查 | HARD | 主Agent内联 | 无对应语言文件 |
> | O10 Lint | HARD | 主Agent内联 | 无配置/CLI |
> | d-1.5 覆盖delta | HARD/SOFT | 主Agent内联 | `tdd_mode=off` |
> | d-2 单元测试 | HARD | 主Agent内联 | 无测试框架 |
> | d-3 回归测试 | SOFT | 主Agent内联 | 非大规模/首task |
> | d-4 性能基准 | SOFT | 主Agent内联 | 无`benchmark_cmd` |
> | e CCC-2 | SOFT | 内联(≤5)/spawn | 非中大规模 |
> | f 质量门B | SOFT | 内联(≤3)/spawn | 非大规模 |
> | g 快照 | — | Shell | 非大规模 |
> | h 标记状态 | — | Shell | — |
